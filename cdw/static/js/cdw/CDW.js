...
], function(_, Config, _regLoginTemplate, _quickreplyTemplate, _yesnoTemplate, _debateTemplate) {
    var isNewUser = true, loginStatus = false, perPage = 25, cookieData, userdata, privateBrowser, CDW = CDW || {};
    var uservote = {};
    ...
    CDW.utils = (function(window, document, $, undefined) {
        ...
        var likes = function(postId, target) {
            ...
            login : function(callback) {
                ...
                var overlay = $("#reg-overlay"), regFrom = $("#reg-overlay #login_or_signup_form"), error = regFrom.find(".error-msg"), submit = regFrom.find(".submit"), email, newuser = true, re = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, username_lookup = function() {
            ...
            loadSDK : function(cfg) {
                var that = this, dfd = $.Deferred(), loadingFB = false, fbscript = "//connect.facebook.net/en_US/all.js";
            ...
            onYesNoView : function(qid, container) {
                var key = "question_" + qid + "_vote", container = $(container);
            ...
            formatDates : function(date) {
                ...
                var d = Date.parse(arr[0]), curr_date = d.getDate(), curr_month = d.getMonth(), curr_year = d.getFullYear();
            ...
            daysDifference : function(date) {
                ...
                //clear trailing millis and split get yy-mm-dd part from horus
                var yr = arr[0].split("-");
                var hr = arr[1].split(":");
