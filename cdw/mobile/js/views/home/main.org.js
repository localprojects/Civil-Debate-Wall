...
'text!templates/debate/debate_home.html', 
 ...
 function ($, 
    ...
    // Consider it the constructor of the class.
        ...
        events: {
            ...
            "click  #topBarIconMenu": "showSlideMenu",
        ...
        postToThread: function () {
            ...
            $.ajax({
                type: "POST",
                url: "http://dev.civildebatewall.com/api/questions/" + that.models.current.data.id + "/threads",
        ...
        getMore : function() {
            this.currentpage++;   
            this.models.debates.url = "http://dev.civildebatewall.com/api/questions/" + this.models.current.data.id + "/posts?skip="+this.currentpage+"&limit="+this.perPage;
           ...
           if (!this.menuStatus) {
           	$("#feeds").quickRef = this;
            	...
            	$("#feeds").animate({
			         ...
			         //hijack scroll events to prevent main content to move over menu
			          $(window).bind('scrollstart', function () {
        					$('#feeds').css('position', 'fixed');
    					});
        ...
        render: function (qid) {
            ...
            if (qid) {
                ...
                that.models.current.url = "http://dev.civildebatewall.com/api/questions/" + qid;
            } else {
                $(".nav.main").show();
            } 
            ...
            this.models.current.fetch({
                ...
                success: function (model, currentdata) {
                    ...
                    that.models.current.data = currentdata;
						...
						//alert("a loaded question "+that.models.current.data.text);
                    ...
                    that.models.debates.url = "http://dev.civildebatewall.com/api/questions/" + currentdata.id + "/posts?skip="+that.currentpage+"&limit="+that.perPage;
                    ...
                    that.models.debates.fetch({
                        ...
                        success: function (model, debatesdata) {
                            ...
                            that.models.stats.url = "http://dev.civildebatewall.com/api/stats/questions/" + currentdata.id;

                            that.models.stats.url = "http://dev.civildebatewall.com/api/stats/questions/"+that.models.current.data.id;
