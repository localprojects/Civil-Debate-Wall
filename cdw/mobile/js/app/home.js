...
window.BrowseMenuItemView = Backbone.View.extend({
  ...
  render: function() {
    ...
    $(this.el).click(function(e) {
      e.preventDefault();
      window.location.href='http://dev.civildebatewall.com/questions/' + data.qid + '/debates/' + data.id;
    });
    return this;
  }
...
window.BrowseMenuView = Backbone.View.extend({
    ...
    $('div.responses-outer').click(function(e) {
      if($(e.target).hasClass('responses-outer')) {
        window.location.href = 
          'http://dev.civildebatewall.com/#/questions/' + models.currentQuestion.id + '/debates/' + models.currentDebate.id;
      }
    });
  ...
  onCloseClick: function(e) {
    e.preventDefault();
    window.location.href = 
      'http://dev.civildebatewall.com/#/questions/' + models.currentQuestion.id + 
      'http://dev.civildebatewall.com/debates/' + models.currentDebate.id;
  },
  ...
  setModelUrl: function(page, amt, sort) {
  	alert("setModelUrl");
    this.model.url = 'http://dev.civildebatewall.com/api/questions/' + models.currentQuestion.id + 
                     'http://dev.civildebatewall.com/threads?page=' + page + '&amt=' + amt + '&sort=' + sort;
  },
...
window.JoinDebateView = Backbone.View.extend({
  ...
  setAdd: function(e) {
    ...
    this.mode = 'add';
    this.configureForm( 
      'http://dev.civildebatewall.com/api/questions/' + models.currentQuestion.id + '/threads',
      function(data) {
        models.currentDebates.add(data);
        window.location.href= 
          'http://dev.civildebatewall.com/#/questions/' + models.currentQuestion.id + '/debates/' + data.id;
        this.remove();
      }
    );
  },
  ...
  finish: function(data) {
    ...
    this.$('a.view-opinion').attr(
      'href', 'http://dev.civildebatewall.com/questions/' + models.currentQuestion.id +
        'http://dev.civildebatewall.com/debates/' + did);
  ...
  shareClick: function(e) {
    ...
    var url = "http://dev.civildebatewall.com/share/" + provider + "/" + did;
    window.open(url);
  }
...
window.ReplyView = Backbone.View.extend({
  ...
  close: function(e) {
    e.preventDefault();
    if(this.showReplies) {
      window.location.href = 'http://dev.civildebatewall.com/#/questions/' + models.currentQuestion.id + '/debates/' + models.currentDebate.id + '/posts';
    } else {
      $('div.responses').show();
      this.remove();
      if(this.fromStats) {
  ...
  shareClick: function(e) {
    e.preventDefault();
    var provider = $(e.currentTarget).attr('title');
    var url = "http://dev.civildebatewall.com/share/" + provider + "/" + models.currentDebate.id;
    window.open(url);
  },
...
window.GalleryView = Backbone.View.extend({
  ...
  onBrowseAllClick: function(e) {
    ...
    if(window.BrowseMenu) {
      ...
      window.location.href = 
        'http://dev.civildebatewall.com/#/questions/' + models.currentQuestion.id + '/debates';
    }
  },
...
window.Question = Backbone.Model.extend({
  urlRoot: 'http://dev.civildebatewall.com/api/questions'
});
...
window.Debate = Backbone.Model.extend({
  urlRoot: 'http://dev.civildebatewall.com/api/threads'
});
...
window.Post = Backbone.Model.extend({
  urlRoot: 'http://dev.civildebatewall.com/api/posts'
});
...
window.Stats = Backbone.Model.extend({
  urlRoot: 'http://dev.civildebatewall.com/api/stats/questions'
});
...
commands.loadDebates = function(qid, callback) {
  var url = 'http://dev.civildebatewall.com/api/questions/' + qid + '/threads?id_offset=' + debateOffset;
...
commands.loadPosts = function(did, callback) {
  if(did != models.currentDebate.id) {
    commands.showSpinner();
    models.currentPosts.url = 'http://dev.civildebatewall.com/api/debates/' + did + '/posts';
...
commands.flagPost = function(postId, callback) {
  $.ajax({
    url: 'http://dev.civildebatewall.com/api/posts/' + postId + '/flag', 
    type: 'POST',
    dataType: 'json',
    success: callback
  });
...
commands.likePost = function(postId, callback) {
  $.ajax({
    url: 'http://dev.civildebatewall.com/api/posts/' + postId + '/like', 
    type: 'POST',
    dataType: 'json',
    success: callback
  });
